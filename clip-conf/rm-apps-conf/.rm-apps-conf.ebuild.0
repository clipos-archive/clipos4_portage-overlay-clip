...
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE="clip-hermes clip-devel rm-h rm-b"
...
SUG2RDEP_HERMES="
	=app-crypt/acid7-utils-1.0.10
	=app-text/stardict-3.0.3-r2
	=dev-libs/libsigc++-2.2.10
	=www-plugins/chrome-binary-plugins-48.0.2564.116_p1
...
RDEPEND="
	...
	amd64? ( =app-office/libreoffice-5.0.5.2 )
	...
	=www-client/chromium-61.0.3163.79-r2
...
DEB_SUGGESTS="
	...
	=app-crypt/AxDecrypt-1.7.2867-r1
	...
	=x11-plugins/exchangecalendar-3.9.0
