...
RDEPEND="
	...
	=app-clip/smartcard-monitor-1.0
	...
	core-rm? ( =app-crypt/cryptd-server-1.5.17-r2 )
	...
	!clip-bare? (
		=media-gfx/splash-theme-clip-2.1.1
	...
	=sys-auth/libgtop11dotnet-2.3.0.03
	...
	amd64? ( =sys-boot/syslinux-4.07-r7 )
	amd64? ( =sys-devel/gcc-lib-5.3.0-r1 )
	...
	clip-kernel-3_14? (
		...
		=sys-kernel/extra-firmwares-3.13.0-r1
		=sys-kernel/wireless-firmwares-3.14.4
	)
	!clip-kernel-3_14? (
		!clip-kernel-4_9? (
		=clip-data/clip-hardware-4.4.9
		=sys-kernel/clip-kernel-4.4.135
		=sys-kernel/extra-firmwares-4.4
		=sys-kernel/wireless-firmwares-4.4.4
	)
	clip-kernel-4_9? (
			=clip-data/clip-hardware-4.4.9
