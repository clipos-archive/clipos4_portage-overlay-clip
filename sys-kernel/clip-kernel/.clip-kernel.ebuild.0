...
"
# For now, we keep the same hardware profiles for 4.4 and 4.9 kernels
# =clip-data/clip-hardware-${KV_MAJOR}.${KV_MINOR}*
# =sys-kernel/wireless-firmwares-${KV_MAJOR}.${KV_MINOR}*
# =sys-kernel/extra-firmwares-${KV_MAJOR}.${KV_MINOR}*
RDEPEND="clip-modular? (	sys-apps/kmod
							...
							=sys-kernel/wireless-firmwares-4.4*
